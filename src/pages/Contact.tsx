      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-12">
          ...
          <motion.p 
            ...
            className="text-gray-500 font-jakarta max-w-lg mx-auto"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-2xl font-bold text-[#001A41] mb-6 font-jakarta">
              Send us a Message
            </h2>
          ...
          >
            ...
            <div className="bg-gradient-to-r from-blue-600 to-blue-400 rounded-xl p-6 shadow-sm text-white">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <Button variant="secondary" className="bg-white text-[#007BFF] hover:bg-white/90 font-medium">
                    Read FAQs
                  </Button>
                </a>
              </div>
        ...
        {/* Testimonial or Reassurance Section */}
        <motion.div 
        ...
        >
          <p className="text-lg text-gray-600 italic font-jakarta">
            "We believe in providing personalized support for your emotional wellness journey. 
            Our team is dedicated to answering your questions and guiding you every step of the way."
          </p>
          <p className="mt-4 font-bold text-[#001A41] font-jakarta">- The Emotions Team</p>
        </motion.div>
      </div>
    </div>
  );
