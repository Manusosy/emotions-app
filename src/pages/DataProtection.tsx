      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <div className="prose prose-blue max-w-none">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">2. Data Protection Principles</h3>
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">3. Data Protection Measures</h3>
            <p className="mb-3 text-gray-700">
              To protect your personal data, we implement robust technical and organizational measures:
            </p>
            
            <h4 className="text-lg font-semibold text-[#001A41] mb-3">3.1 Technical Measures</h4>
            ...
            <h4 className="text-lg font-semibold text-[#001A41] mb-3">3.2 Organizational Measures</h4>
            <ul className="list-disc pl-5 mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">4. Data Breach Response</h3>
            <p className="mb-3 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">5. Data Subject Rights</h3>
            <p className="mb-3 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">6. Data Processing Records</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">7. Data Protection Impact Assessments</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">8. Data Protection Officer</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">9. International Data Transfers</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">10. Employee Training</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">11. Third-Party Data Processors</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">12. Updates to This Policy</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">13. Contact Information</h3>
            <p className="mb-4 text-gray-700">
