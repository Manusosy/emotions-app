      ...
      <div className="container mx-auto px-4 py-16">
        ...
        >
          <div className="prose prose-blue max-w-none">
            <h3 className="text-xl font-bold text-[#001A41] mb-4">1. Acceptance of Terms</h3>
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">2. Eligibility</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">3. Service Description</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">4. Account Registration</h3>
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">5. User Responsibilities</h3>
            <p className="mb-3 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">6. Intellectual Property Rights</h3>
            <p className="mb-3 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">7. Privacy</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">8. Subscription and Payment</h3>
            <p className="mb-3 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">9. Termination</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">10. Disclaimer of Warranties</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">11. Limitation of Liability</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">12. Indemnification</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">13. Governing Law</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">14. Changes to Terms</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">15. Severability</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">16. Entire Agreement</h3>
            <p className="mb-6 text-gray-700">
            ...
            <h3 className="text-xl font-bold text-[#001A41] mb-4">17. Contact Information</h3>
