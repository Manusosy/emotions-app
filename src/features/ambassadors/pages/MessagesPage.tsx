      ...
      <div className="container mx-auto py-10 px-4">
        <div className="flex flex-col items-center justify-center text-center py-16 max-w-3xl mx-auto">
          ...
          <p className="text-gray-600 mb-8 max-w-md">
            We're building a comprehensive messaging platform for you to connect with your clients and manage your communications effectively. This feature will be available soon!
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Button variant="outline" asChild>
              <Link to="/ambassador-dashboard/clients">
                Manage Clients
              </Link>
            </Button>
          </div>
