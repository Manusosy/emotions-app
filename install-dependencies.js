...
try {
  if (platform === 'linux') {
    ...
    execSync('npm install --no-save @rollup/rollup-linux-x64-gnu@4.9.1 @rollup/rollup-linux-x64-musl@4.9.1 @rollup/rollup-win32-x64-msvc@4.9.1 @rollup/rollup-darwin-x64@4.9.1', { stdio: 'inherit' });
  }
