// Script to apply the gender column migration
...
async function applyMigration() {
  try {
    ...
    const migrationPath = path.join(__dirname, 'supabase/migrations/20240625000000_add_gender_column.sql');
    let migrationSql;
    ...
    try {
      ...
      migrationSql = `
-- Add missing 'gender' column to ambassador_profiles table
DO $$
BEGIN
    IF NOT EXISTS (
        SELECT 1
...
$$;`;
    ...
    console.log('The gender column is now available in the ambassador_profiles table.');
  } catch (error) {
